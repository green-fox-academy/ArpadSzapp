...
void draw(int x1, int y1) {
        ...
        SDL_RenderDrawLine(gRenderer, SCREEN_WIDTH - 25, (SCREEN_HEIGHT -25)-y1,
                           (SCREEN_WIDTH -25)- x1, 25);

        // Draw the canvas' diagonals.

        SDL_SetRenderDrawColor(gRenderer, 0xff /*R*/, 0x00 /*G*/, 0x00 /*B*/, 0xFF /*A*/);
        SDL_RenderDrawLine(gRenderer, 25, (SCREEN_HEIGHT-25)-y1,
                           SCREEN_WIDTH-25-x1, SCREEN_HEIGHT-25);
        x1 += 25;
        y1 += 25;
