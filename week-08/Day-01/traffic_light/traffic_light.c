...
#define greenLED_OFF HAL_GPIO_WritePin(GPIOF, GPIO_PIN_10, GPIO_PIN_RESET);
#define yellowLED_OFF HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, GPIO_PIN_RESET);
#define redLED_OFF HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, GPIO_PIN_RESET);

#define greenLED_ON HAL_GPIO_WritePin(GPIOF, GPIO_PIN_10, GPIO_PIN_SET);
#define yellowLED_ON HAL_GPIO_WritePin(GPIOF, GPIO_PIN_9, GPIO_PIN_SET);
#define redLED_ON HAL_GPIO_WritePin(GPIOF, GPIO_PIN_8, GPIO_PIN_SET);
...
int main(void) {
	...
	while (1) {
		...
		} else if (tim_val < 12000) {
			greenLED_OFF;
			yellowLED_ON;

		} else if (tim_val < 20000) {
			yellowLED_OFF;
			redLED_ON;

		} else if (tim_val < 24000) {
			yellowLED_ON;
		}
	}
}
